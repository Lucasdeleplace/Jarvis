...
export type AgentEvent =
  ...
  | { readonly type: "agent.token"; readonly token: string }
  | { readonly type: "agent.tool_call"; readonly capabilityId: string }
  | { readonly type: "agent.done" }
  | { readonly type: "agent.error"; readonly message: string };
